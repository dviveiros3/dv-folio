...
export function EngageSection({ isVisible, sectionRef }: EngageSectionProps) {
    return (
        <section
            ref={sectionRef}
            id="engage"
            className="min-h-screen flex items-center px-8 py-32 bg-slate-900 text-white"
        >
                ...
                >
                    ...
                    <div className="space-y-6 max-w-2xl">
                        ...
                        <p className="text-xl text-slate-400 font-normal">
                            Available for Executive Search, Leadership Coaching, and Org Strategy.
                        </p>
                    </div>

                    {/* Links Grid - Hierarchical */}
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4">

                        {/* Primary Action - Dominant */}
                        <CalendlyEmbed url="https://calendly.com/daniel-viveiros/15min-intro">
                            <motion.div
                                className="col-span-1 md:col-span-2 lg:col-span-8 bg-slate-900 p-10 lg:p-12 flex flex-col justify-between group hover:bg-slate-800 transition-colors relative overflow-hidden cursor-pointer"
                            ...
                            >
                                ...
                                <div className="space-y-4 relative z-10">
                                    ...
                                    <h3 className="text-3xl font-semibold text-white">Book a Career Strategy Call</h3>
                                    <p className="text-slate-400 max-w-md">
                                        15 minutes to clarity. We'll diagnose your talent gaps and outline a hiring roadmap. If I'm not the right partner, I'll refer you to someone who is.
                                    </p>
                                </div>
